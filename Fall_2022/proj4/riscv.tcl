...
namespace eval ::optrace {
  variable script "/nethome/jkjar6/project_4-pt2/project_4-pt2.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir /nethome/jkjar6/project_4-pt2/project_4-pt2.cache/wt [current_project]
  set_property parent.project_path /nethome/jkjar6/project_4-pt2/project_4-pt2.xpr [current_project]
  set_property ip_repo_paths /nethome/jkjar6/project_4-pt2/comm_vitis/comm_ip [current_project]
  update_ip_catalog
  set_property ip_output_repo /nethome/jkjar6/project_4-pt2/project_4-pt2.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet /nethome/jkjar6/project_4-pt2/project_4-pt2.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files /nethome/jkjar6/project_4-pt2/project_4-pt2.srcs/sources_1/bd/design_1/design_1.bd
...
OPTRACE "link_design" START { }
  set_param project.isImplRun true
  link_design -top design_1_wrapper -part xc7z010iclg225-1L
