...
namespace eval ::optrace {
  variable script "/nethome/jkjar6/project_5/project_5.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir /nethome/jkjar6/project_5/project_5.cache/wt [current_project]
  set_property parent.project_path /nethome/jkjar6/project_5/project_5.xpr [current_project]
  set_property ip_repo_paths /nethome/jkjar6/project_5/hls_output [current_project]
  update_ip_catalog
  set_property ip_output_repo /nethome/jkjar6/project_5/project_5.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet /nethome/jkjar6/project_5/project_5.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files /nethome/jkjar6/project_5/project_5.srcs/sources_1/bd/design_1/design_1.bd
